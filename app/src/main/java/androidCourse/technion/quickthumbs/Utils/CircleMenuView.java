...
public class CircleMenuView extends FrameLayout {
    ...
    private FloatingActionButton hiddenMenuButton;
    ...
    public CircleMenuView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        try {
            ...
            mIconMenu = a.getResourceId(R.styleable.CircleMenuView_icon_menu, R.drawable.logo);
            mIconClose = a.getResourceId(R.styleable.CircleMenuView_icon_close, R.drawable.logo);
    ...
    public CircleMenuView(@NonNull Context context, @NonNull List<Integer> icons, @NonNull List<Integer> colors) {
        ...
        mIconMenu = R.drawable.logo;
        mIconClose = R.drawable.logo;
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        hiddenMenuButton.getContentRect(mButtonRect);
    ...
    private void initMenu(int menuButtonColor) {
        ...
        hiddenMenuButton = findViewById(R.id.circle_menu_hidden_main_button);
    ...
    private void offsetAndScaleButtons(float centerX, float centerY, float angleStep, float offset, float scale) {
        for (int i = 0, cnt = mButtons.size(); i < cnt; i++) {
            ...
            //the two values below make the button appear bigger if you douvble the scale
            button.setScaleX(1.5f * scale);
            button.setScaleY(1.5f * scale);
        }
    }
    ...
    private Animator getButtonClickAnimation(final @NonNull FloatingActionButton button) {
        ...
        final float elevation = hiddenMenuButton.getCompatElevation();
    ...
    private Animator getOpenMenuAnimation() {
        ...
        final float centerX = hiddenMenuButton.getX();
        final float centerY = hiddenMenuButton.getY();
